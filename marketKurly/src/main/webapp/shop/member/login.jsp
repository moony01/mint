...
<body>
    ...
    <header class="header">
        ...
        <ul class="my-page">
            <li class="my-page__item login"><a href="/marketKurly/shop/member/join.jsp">회원가입</a></li>
            <li class="my-page__item join"><a href="/marketKurly/shop/member/login.jsp">로그인</a></li>
